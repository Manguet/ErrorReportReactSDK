import require$$0, { Component, createContext, useMemo, useContext, useCallback } from 'react';
...
const useErrorReporter = () => {
    ...
    const reportMessage = useCallback(async (message, level = 'error', additionalData) => {
